...
const BuyModal = () => {
	console.log("buymodalll")
	const { buyModal, collectionsdata} = useSelector((state) => state.counter);
						...
						<div className="modal-content">
							...
							<div className="modal-body p-6">
								...
								<div className="dark:border-jacarta-600 border-jacarta-100 relative flex items-center border-t border-b py-4">
									<figure className="mr-5 self-start">
										<img
											src={collectionsdata.tokenUriRes.image}
											alt="avatar 2"
									...
									<div>
										<a href="collection.html" className="text-accent text-sm">
											{collectionsdata.tokenUriRes.name}
										</a>
										<h3 className="font-display text-jacarta-700 mb-1 text-base font-semibold dark:text-white">
											{collectionsdata.tokenUriRes.description}
										</h3>
									...
									<div className="ml-auto">
										<span className="mb-1 flex items-center whitespace-nowrap">
											...
											<span className="dark:text-jacarta-100 text-sm font-medium tracking-tight">
												{parseInt(collectionsdata.price.toString()) } AVAX
											</span>
										</span>
								...
								<div className="dark:border-jacarta-600 border-jacarta-100 mb-2 flex items-center justify-between border-b py-2.5">
									...
									<div className="ml-auto">
										<span className="flex items-center whitespace-nowrap">
											...
											<span className="text-green font-medium tracking-tight">{parseInt(collectionsdata.price.toString())} AVAX</span>
										</span>
							...
							<div className="modal-footer">
								<div className="flex items-center justify-center space-x-4">
									<Confirm_checkout payload={collectionsdata}/>
								</div>
							</div>
						</div>
					</div>
