...
import User_collection_token from '../categories/user_collection_token';

const User_collection_items = ({collection, isloading, collectiondetails}) => {
				...
				<div className="container">
					...
					<Tabs className="tabs">
						...
						<TabPanel>
							{!isloading ? 
							<div>
								<User_collection_token collection={collection} collectiondetails={collectiondetails}/>
							</div> : 
...
export default User_collection_items;
