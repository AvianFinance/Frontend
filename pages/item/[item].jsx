...
import  nftdatas from "../../scripts/nftdata";
					...
					<div className="container">
						...
						{items_data
							...
							.map((item) => {
								...
								const image = nftdata.tokenUriRes.image
								const title = nftdata.tokenUriRes.name
								const id = nftdata.jsnresponse.token_id
								const text = nftdata.tokenUriRes.description
